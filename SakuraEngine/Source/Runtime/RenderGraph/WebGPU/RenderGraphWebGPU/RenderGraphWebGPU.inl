...
FORCEINLINE WGPUTextureFormat sakura::graphics::webgpu::translate(const ETextureFormat format)
{
	switch (format)
	{
		trans_cases
...
FORCEINLINE sakura::graphics::ETextureFormat sakura::graphics::webgpu::translate(const WGPUTextureFormat format)
{
	switch (format)
	{
		trans_cases
...
FORCEINLINE WGPUBlendFactor sakura::graphics::webgpu::translate(const EBlendFactor factor)
{
	switch (factor)
	{
...
FORCEINLINE WGPUBlendOperation sakura::graphics::webgpu::translate(const EBlendOp op)
{
	switch (op)
	{
...
FORCEINLINE WGPUColorWriteMaskFlags sakura::graphics::webgpu::translate(const ColorMask mask)
{
...
FORCEINLINE WGPUVertexFormat sakura::graphics::webgpu::translate(const EVertexFormat vertex_format)
{
...
FORCEINLINE WGPUIndexFormat sakura::graphics::webgpu::translate(const EIndexFormat index_format)
{
...
FORCEINLINE WGPUInputStepMode sakura::graphics::webgpu::translate(const VertexLayout::Frequency freq)
{
	switch (freq)
	{
...
FORCEINLINE WGPUPrimitiveTopology sakura::graphics::webgpu::translate(const EPrimitiveTopology topo)
{
	switch (topo)
	{
...
FORCEINLINE WGPUBufferUsageFlags sakura::graphics::webgpu::translate(const BufferUsages usage, const EBufferCPUAccess access)
{
...
FORCEINLINE WGPUTextureDimension sakura::graphics::webgpu::translate(const ETextureDimension dimension)
{
	switch (dimension)
	{
...
FORCEINLINE WGPUTextureViewDimension sakura::graphics::webgpu::match(const WGPUTextureDimension dimension)
{
	switch (dimension)
	{
...
FORCEINLINE WGPULoadOp sakura::graphics::webgpu::translate(const ELoadOp op)
{
	switch (op)
	{
...
FORCEINLINE WGPUStoreOp sakura::graphics::webgpu::translate(const EStoreOp op)
{
	switch (op)
	{
...
FORCEINLINE WGPUPresentMode sakura::graphics::webgpu::translate(const EPresentMode mode)
{
	switch (mode)
	{
...
FORCEINLINE WGPUTextureAspect sakura::graphics::webgpu::translate(const ETextureAspect aspect)
{
	switch (aspect)
	{
...
FORCEINLINE WGPUTextureCopyView sakura::graphics::webgpu::translate(const TextureSlice from, const WGPUTexture texture)
{
...
FORCEINLINE WGPUBufferCopyView sakura::graphics::webgpu::translate(const TextureDataLayout layout, const WGPUBuffer buffer)
{
...
FORCEINLINE WGPUFilterMode sakura::graphics::webgpu::translate(const EFilter filter)
{
	switch (filter)
	{
	case EFilter::Linear:
...
FORCEINLINE WGPUAddressMode sakura::graphics::webgpu::translate(const ESamplerAddressMode mode)
{
	switch (mode)
	{
