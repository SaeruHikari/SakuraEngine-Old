...
namespace sakura
{
    ...
    {
        using VectorStorage = sakura::math::__vector::VectorRegister;
    public:
        FORCEINLINE Transform(
            const Quaternion& rotation, const Vector3f& translation, const Vector3f& scale = Vector3f::vector_one())
        {
            rotation_ = sakura::math::__vector::load_aligned(rotation.data_view());
            translation_ = sakura::math::__vector::load_float3_w0(translation.data_view());
            scale_ = sakura::math::__vector::load_float3_w0(scale.data_view());
        }
    ...
    protected:
        VectorStorage rotation_ = sakura::math::__vector::register_zero;
        VectorStorage translation_ = sakura::math::__vector::vector_register(0.f, 0.f, 0.f, 1.f);
        VectorStorage scale_ = sakura::math::__vector::register_one;
    };
