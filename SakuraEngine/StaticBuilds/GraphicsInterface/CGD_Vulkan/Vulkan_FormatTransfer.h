 ...
 * @LastEditTime: 2020-03-05 22:36:36
 */
#pragma once
...
namespace Sakura::Graphics::Vk
{
    VkFormat Transfer(const Sakura::Graphics::PixelFormat format)
    {
        ...
        VK_FORMAT_MAPPING(R16G16B16A16_SNORM, VK_FORMAT_R32G32B32_SFLOAT);
        ...
        VK_FORMAT_MAPPING(R10G10B10A2_TYPELESS_PACK32,
        ...
        VK_FORMAT_MAPPING(R8G8_SNORM, VK_FORMAT_R8G8_UNORM);
